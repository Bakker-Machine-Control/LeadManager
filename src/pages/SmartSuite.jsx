...
function metaFields(r, ssStr) {
  return {
    meta_lead_id: ssStr(r.s9feaf3fda),
    ad_id: ssStr(r.sa4e1203ff),
    ad_naam: ssStr(r.sa4820cf90),
    campagne: ssStr(r.s924edf549),
    formulier: ssStr(r.s351517cff),
    platform: ssStr(r.s335a1f6d0),
    aangeleverde_tekst: ssStr(r.sfa31637c2),
  };
}
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-2xl font-bold">SmartSuite</h1>
