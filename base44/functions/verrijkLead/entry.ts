...
// Leadverrijking met scoring. Zelfde code als enrichLead, onder een nieuwe
// naam: de uitrol van enrichLead bleef op een oude versie hangen, en een
// functie met een nieuwe naam wordt wel direct uitgerold.
//
...
export default async function (req) {
  try {
    ...
    console.error('verrijkLead error:', error.message);
